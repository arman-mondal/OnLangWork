...
export default class TeacherList extends React.Component {
  ...
  componentDidMount () {
    ...
    axios({
        method: "get",
        url:  configData.SERVER_URL + 'teachers/getinstitutionteachers',
        headers: { 
                        ...
                        <tbody>
                          {this.state.teachers.map((teacher , index) => ( 
                            <tr>
                              ...
                              <td>{teacher.email}</td>
                              <td>{teacher.phone}</td>
                              <td>{ moment(teacher.registeron).format('DD/MM/YYYY')}</td>
                              <td>
                                {(() => {
                              ...
                              <td><a href={ "/teacherdetails/" + teacher.teacherid} className="btn-buy">View</a></td>
                            </tr>
                            ))}
                        </tbody>
                      </Table>
