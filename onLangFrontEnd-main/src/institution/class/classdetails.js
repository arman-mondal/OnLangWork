          ...
          if(resp.data.code == 200){
            ...
            if(resp.data.code == 201){
              ...
              swal({
                ...
                text: "You don't have access to view the details of that class.",
                icon: "warning",
                button: "ok",
              });
            }
                    ...
                    <div className="row">
                      <div className="col-lg-4 col-md-4 mt-12 mt-lg-0">
                        ...
                        <Form.Group>
                          ...
                          <a className="btn-buy" onClick={this.slotsModalShow}>View Schedule</a>
                          <a className="btn-buy" onClick={this.liveclassModalShow}>View History</a>
                      </div>
                      <div className="col-lg-8 col-md-8 mt-12 mt-lg-0">
                        <Table striped bordered hover>
                          <tbody>
                            ...
                            <tr>
                              <td>Price</td>
                              <td>{this.state.package.packageprice} USD</td>
                            </tr>
                            <tr>
                              <td>Used Slots</td>
                              <td>{this.state.subcription.usedslots}</td>
                            </tr>
                            <tr>
                              <td>Subscription Date</td>
                              <td>{ moment(this.state.subcription.subscriptiondate).format('DD/MM/YY')}</td>
                            </tr>
                            <tr>
                        ...
                        <Table striped bordered hover>
                          ...
                          {this.state.students.map((student , index) => ( 
                            <tr>
                              ...
                              <td>{ moment(student.student.registeron).format('DD/MM/YYYY')}</td>
                              <td>
                                {(() => {
