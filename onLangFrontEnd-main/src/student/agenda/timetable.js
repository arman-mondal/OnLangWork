import '../../teacher/agenda/agenda.css';
...
export default class StudentTimetable extends React.Component{
  constructor(props) {
    ...
    this.currentDateChange = (currentDate) => { 
        ...
        this.getClasses(this.props.user[0].studentid,currentDate) 
    };
  }
  componentDidMount () {
    if(this.props.token){
  ...
  getClasses(studentid,date){
    ...
    bodyFormData.append('studentid', studentid);
     axios({
      method: "post",
      url:  configData.SERVER_URL + 'classes/getStudentTimetable',
      data: bodyFormData,
      headers: { 
        ...
        if(resp.data.code === 200){
          ...
          console.log(new Date(startingHour).getHours())
