...
export default class TeacherRecordingsCourseSelection extends React.Component {
            ...
            <div className="container">
              <div className="col-lg-12 col-md-12 mt-6 mt-lg-0">
                <div className="box price featured no-padding">
                  <Card className="p-3">
                    <h3>Select Course to View the Recordings</h3>
                          ...
                          <tbody>
                            {this.state.courses.map((course , index) => ( 
                              <tr>
                                ...
                                <td><a href={ "/teacherclassesrecordings/" + course.course.courseid} className="btn-buy">View</a></td>
                              </tr>
                              ))}
                          </tbody>
                        </Table>
