...
export default class TeacherGroupList extends React.Component {
  ...
  componentDidMount () {
    ...
    axios({
        method: "get",
        url:  configData.SERVER_URL + 'groups/teachergrouplist',
        headers: { 
                        ...
                        <tbody>
                          {this.state.groups.map((group , index) => ( 
                            <tr>
                              ...
                              <td><a href={ "/teachergroupdetails/" + group.groupid} className="btn-buy">View</a></td>
                            </tr>
                            ))}
                        </tbody>
                      </Table>
